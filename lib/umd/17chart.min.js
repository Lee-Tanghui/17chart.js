!(function(e, t) {
  ...
  const y = {
    ...
    x = (e, t) => {
      ...
      if (i) {
        ...
        h(e, `${o}.axisLabel.formatter`, function(e) {
          return (100 * e).toFixed(d) + '%'
        }),
          p(e, `${o}.minInterval`) >= 1 && h(e, `${o}.minInterval`, 0.1)
      }
      if (A(t)) {
        p(t, 'xAxis.axisLabel.formatter') ||
    ...
    b = e => {
      const t = p(e, 'xAxis.axisLabel.rotate'),
        o = v(e),
        r = ((e, t) => {
          let o = 0,
            r = 0
    ...
    A = e => {
      let t = !1
      return p(e, 'xAxis.axisLabel.rotate') && (t = !0), t
    },
    v = e => {
    ...
    E = e => 'category' === p(e, 'yAxis.type'),
    L = e => {
      let t = !0
      const o = p(e, 'name')
      return (
        (!1 !== p(e, 'legend.show') && o && o.length) || (t = !1),
        p(e, 'groupField') && (t = !0),
        t
      )
    },
  ...
  class O {
    ...
    constructor(e, t) {
      if (
        ...
        'category' === p(t, 'yAxis.type'))
      ) {
        const e = p(t, 'data')
        const o = 30 * (i(e) ? p(t, 'data.0').length : e.length)
    ...
    _validate(e, t) {
      ...
      if ('string' != typeof e || this.container)
        if ('string' == typeof e || 1 === this.container.nodeType)
          if (((o = p(t, 'data')), Array.isArray(o))) var o
          else
